...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/charts/jquery.flot.stack.js') }}" type="text/javascript" ></script>
    ...
    <script src="{{ asset('assets/vendors/charts/jquery.flot.categories.js') }}" type="text/javascript"></script>
