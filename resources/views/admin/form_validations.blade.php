                        ...
                        <div class="col-md-6">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <form id="form-validation" action="form_validations" method="post" class="form-horizontal">
                                    ...
                                    <div class="row">
                                        <form role="form">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <input type="password" name="password_confirmation" class="form-control input-md" placeholder="Confirm Password" tabindex="6"></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-2">
