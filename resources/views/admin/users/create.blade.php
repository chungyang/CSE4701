                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="facebook" name="facebook" class="form-control" value="{!! Input::old('facebook') !!}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="twitter" name="twitter" class="form-control" value="{!! Input::old('twitter') !!}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="google_plus" name="google_plus" class="form-control"  value="{!! Input::old('google_plus') !!}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="skype" name="skype" class="form-control" value="{!! Input::old('skype') !!}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="flickr" name="flickr" class="form-control" value="{!! Input::old('flickr') !!}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="youtube" name="youtube" class="form-control" value="{!! Input::old('youtube') !!}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
