...
<html>
<head>
    <title>Register | Chinook Admin Template</title>
            ...
            <div class="panel-body social col-sm-offset-3">
                <div class="col-xs-12 col-sm-8 ">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('admin-register') }}">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" for="phone">Fax:</label>
                            <div class="col-xs-9">
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-fw fa-phone text-primary"></i>
                                    </span>
                                    <input type="text" placeholder="Fax Number" class="form-control" name="fax" id="fax"  value="{!! Input::old('fax') !!}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" for="address">Full Address:</label>
                            <div class="col-xs-9">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" for="zip">City:</label>
                            <div class="col-xs-9">
                                <input type="text" class="form-control" id="state" name="state" placeholder="State Name" value="{!! Input::old('state') !!}"></div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-xs-3" for="zip">State:</label>
                            <div class="col-xs-9">
                                <input type="text" class="form-control" id="state" name="state" placeholder="State" value="{!! Input::old('state') !!}"></div>
                        </div>
