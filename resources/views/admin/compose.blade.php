...
@section('header_styles')
    <link href="{{ asset('assets/vendors/bootstrap-wysihtml5/core-b3.css') }}" rel="stylesheet" media="screen" type="text/css" />
...
@section('footer_scripts')
        ...
        <script src="{{ asset('assets/vendors/bootstrap-wysihtml5/core-b3.js') }}" type="text/javascript" ></script>
