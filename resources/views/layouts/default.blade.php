...
<head>
    ...
    <title>
        @section('title') | Welcome to Chinook Frontend
        @show
    </title>
    <!-- global css Start -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/frontend/ostrich_webfonts/ostrich-sans.css') }}">
...
<body>
    ...
    <header>
        <nav class="navbar ">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('home') }}">Chinook</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <p>Copyright © Chinook Admin Template, 2015</p>
                </div>
            <!-- Icon Section Start -->
            <div class="pad_top10">
    ...
    <script type="text/javascript" src="{{ asset('assets/js/frontend/Chinook.js') }}"></script>
    <!-- //global js End -->
    <!-- page level js Start -->
