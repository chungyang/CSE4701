        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12 text-center">
                <div class="left_text_box">
                    <h3>Chinook-The Most Complete Popular Admin & Frontend Theme</h3> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.
                    <br />
                    <div class="anim">
